	...
	**/
	function headElements(){ 
		...
		if($desarrollo=="si"){ //Si esta marcado "si" en el functions.php muestra esto (es mejor asi para revisar el codigo)
			...
			echo "<link type='text/css' rel='stylesheet' media='screen' href='".$urltheme."/css/fontawesome-all.min.css'>"."\n"; //Font Awesome
	...
	**/
	...
	?>
		<script type="text/javascript">
			jQuery(function(){
				jQuery('#commentsdiv, #authordiv, #revisionsdiv, #slugdiv, #commentstatusdiv, #trackbacksdiv, #postexcerpt, #tagsdiv-post_tag, #postimagediv, #postcustom').remove(); 
			});
		</script>
	<?
	}
	add_action("admin_footer" , "esconderpaneles");
