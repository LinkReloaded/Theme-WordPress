<?php 
	/**
		...
		Datos de la versión
	**/		
	$desarrollo 	=	"no"; //Cambia el CSS de acuerdo a si el sitio esta publicado o no
    ...
    $versiontheme	.=	"<strong>ÍCONOS:</strong> fontawesome-free-5.3.1-web"."<br/>"; //Iconos precargados
    $versiontheme	.=	"<strong>VERSIÓN: 2018-10-09</strong>"."<br/>"; //Última fecha de cambios.
